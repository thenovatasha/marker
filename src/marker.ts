...
function printFail(str: string) {
    return chalk.red.bold(str);
}
function printSuccess(str: string) {
...
function printCode(str: string) {
    return chalk.yellow.bold(str);
}

function printPath(str: string) {
    return chalk.cyan(str);
}

async function mark(mark: string, options: { replace: boolean }) {
    let dir = cwd();
    try {
...
async function remove_mark(mark: string) {
    try {
...
async function get_mark(mark: string) {
    try {
